            ...
            <aside className="col-md-4">
                <article className="sidebar">
                    ...
                    <ul className="sidebar-body">
                        ...
                        <li>
                            Those interested in meeting and making a connection with
                ...
                <article className="sidebar">
                    ...
                    <p className="sidebar-body">
                        While you attend the conference, head over to our gallery where
                        you can check out some of the work from our speakers.
                    </p>
                    <Images />
                </article>
            </aside>
